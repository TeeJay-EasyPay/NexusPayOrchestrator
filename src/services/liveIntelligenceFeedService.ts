...
export async function getLiveTreasuryFeeds(): Promise<TreasuryFeedItem[]> {
  ...
  return [
    ...
    },
    {
      ...
      insight: "Indonesia corridor is available with tighter route capacity thresholds.",
      asOf: now,
      health: "degraded",
    },
    {
    ...
    },
    {
      ...
      fxStability: "HIGH",
      recommendation: "Normal Operations",
      insight: "Saudi corridor remains stable with moderate route capacity pressure under peak demand.",
      asOf: now,
      health: "live",
    },
    {
    ...
    },
    {
      ...
      fxStability: "MEDIUM",
      recommendation: "Monitor Capacity",
      insight: "Kuwait corridor remains available with heightened route capacity monitoring.",
      asOf: now,
      health: "degraded",
    },
    {
      ...
      fxStability: "MEDIUM",
      recommendation: "Monitor Capacity",
      insight: "Bahrain corridor is active with tighter route capacity thresholds for larger tickets.",
      asOf: now,
      health: "degraded",
    },
    {
