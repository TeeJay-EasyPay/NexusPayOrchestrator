...
const tabs = [
  { label: "Home", route: "/consumer", match: "/consumer", icon: "home" },
  { label: "Send", route: "/consumer/send", match: "/consumer/send", icon: "send" },
  { label: "Transfers", route: "/consumer/transfers", match: "/consumer/transfers", icon: "list" },
  { label: "Profile", route: "/consumer/profile", match: "/consumer/profile", icon: "user" },
  { label: "Settings", route: "/consumer/settings", match: "/consumer/settings", icon: "settings" },
] as const;
    ...
    <SafeAreaView style={styles.safe}>
      <View style={styles.root}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
          <View style={styles.header}>
            <View style={styles.identity}>
              ...
              <Pressable onPress={() => router.push("/" as never)} style={styles.operatorLink}>
                <Feather name="grid" size={15} color={consumerColors.white} />
              </Pressable>
            </View>
        ...
        <View style={styles.nav}>
          {tabs.map((tab) => {
            const active = tab.route === "/consumer" ? pathname === tab.route : pathname.startsWith(tab.match);
