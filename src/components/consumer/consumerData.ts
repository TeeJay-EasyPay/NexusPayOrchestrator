...
export const transferTimeline = [
  ...
  { title: "Payment received", state: "Done", detail: "Your payment source was authorised." },
  { title: "Money sent", state: "In progress", detail: "Delivery partner is processing payment." },
  { title: "Receipt ready", state: "Next", detail: "We will attach the receipt after delivery." },
];
