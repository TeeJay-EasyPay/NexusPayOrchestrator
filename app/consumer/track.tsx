...
export default function ConsumerTrackScreen() {
  return (
    <ConsumerShell
      ...
      subtitle="Clear progress, confidence and receipt access without operational detail."
    >
      <ConsumerCard>
      ...
      <ConsumerCard accent>
        ...
        <AppText color={consumerColors.muted}>
          Your transfer is moving normally. We will notify you if the delivery time changes or if you need to take action.
        </AppText>
      </ConsumerCard>

      <ConsumerAction label="View receipt" icon="file-text" onPress={() => undefined} />
    </ConsumerShell>
  );
}
