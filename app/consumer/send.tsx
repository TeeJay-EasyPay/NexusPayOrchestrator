...
export default function ConsumerSendScreen() {
  return (
    <ConsumerShell
      eyebrow="SEND"
      title="Send money"
      subtitle="Choose the amount, recipient and the delivery option that fits today."
    >
      <ConsumerCard>
        ...
        {routeOptions.map((option) => (
          ...
          >
            ...
            <AppText color={consumerColors.text} style={{ fontWeight: "900" }}>
              Recipient gets {option.received}
            </AppText>
      ...
      <ConsumerCard>
        ...
        <AppText color={consumerColors.muted}>
          You will see the full receipt, delivery estimate and cancellation information before confirming.
        </AppText>
