...
const settings = [
  ...
  ["Verification", "Identity checks for live transfers"],
];
...
export default function ConsumerSettingsScreen() {
  ...
  return (
    <ConsumerShell
      eyebrow="SETTINGS"
      title="Settings"
      subtitle="Simple controls for your money, security and guidance."
    >
      ...
      <ConsumerCard accent>
        ...
        <AppText color={consumerColors.muted}>
          Choose how much guidance Nexus AI gives you while sending and tracking money.
        </AppText>
